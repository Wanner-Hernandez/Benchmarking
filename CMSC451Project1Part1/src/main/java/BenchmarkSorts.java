 ...
 * Date: June 13,2021
 * Description: Performs sorts on 10 different input sizes. 
 * Each input size is ran 50 times. 
 * The results are written to files called 
 * iterative.txt and 
 * recursive.txt
 */
...
public class BenchmarkSorts {
  ...
  private YourSort heapSort = new YourSort();
